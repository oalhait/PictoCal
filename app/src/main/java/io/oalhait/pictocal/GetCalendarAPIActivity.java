...
public class GetCalendarAPIActivity extends Activity {
            ...
            if (mLastError != null) {
                if (mLastError instanceof GooglePlayServicesAvailabilityIOException) {
                    ...
                    startActivityForResult(
                            ...
                            GetCalendarAPIActivity.REQUEST_AUTHORIZATION);
                } else {
